...
import defaultCover from "../../../src/assets/default-cover-photo.gif";
        ...
        <div className="relative mb-2 w-full pt-[56%]">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-x-0 bottom-0">
              <div className="relative border-t bg-[#023f4f] p-4 text-cyan-400 backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
          ...
          {isEditAndDelete && isOwner && (
            <div className="flex gap-x-2">
              <button
                ...
                className="text-cyan-400 w-[6rem] bg-[#003643] px-3 py-1.5 rounded-lg"
              >
                Edit
              </button>
              <button
                onClick={() => setShowDeletePop(true)}
                className="text-cyan w-[6rem] bg-[#013f4e] px-3 py-1.5 rounded-lg"
              >
                Delete
              </button>
            </div>
