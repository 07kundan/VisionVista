    ...
    <>
      <div className="relative block" ref={dropdownRef}>
        <button
          ...
          className="flex items-center gap-x-2 rounded-lg bg-[#053a47] px-4 py-1.5 text-cyan-400"
        >
        ...
        {showDropdown && (
          <div className="absolute right-0 top-full z-10  w-64 overflow-hidden rounded-lg bg-[#053a47] p-4 shadow shadow-cyan-50/30 ">
            ...
            <form onSubmit={(e) => onSubmit(e)} className="flex flex-col">
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-transparent bg-[#053a47] px-3 py-2 text-cyan-400 outline-none focus:border-[#053a47]"
              />
              <button
                type="submit"
                className="mx-auto mt-4 rounded-lg bg-[#053a47] px-4 py-2 text-cyan-400"
              >
                Create new playlist
              </button>
            </form>
