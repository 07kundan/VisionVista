      ...
      <div className="w-full flex justify-center items-center flex-col sm:flex-row">
          ...
          {!isEditing && (
            <div className="w-full">
              ...
              <input
                ...
                accept="image/*"
                disabled={isPending}
                className="w-full border border-[#14d0ff] p-1 file:mr-4 file:border-none file:bg-[#20b2d6] file:px-3 file:py-1.5"
        ...
        <div className="right-side h-full sm:w-4/12 p-4 w-full mb-[4rem]">
          <div className="flex flex-col w-full h-full gap-6">
            <h3 className="text-[1.2rem] text-cyan-500 mx-auto font-extrabold">
              ...
              {isPending ? (
                ...
                <>
                  ...
                  <CustomButton_
                    type="submit"
                    disabled={isPending}
                    className="min-w-[8rem] text-black"
                  >
