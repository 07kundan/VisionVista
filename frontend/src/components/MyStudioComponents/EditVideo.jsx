...
import { setShowEditVideo } from "@/features/ui.slice.js";
import { setVideoForEdit } from "@/features/video.slice.js";
      ...
      <div className="h-full overflow-auto border bg-[#121212] ">
        <div className="flex items-center justify-between border-b p-4">
          ...
          <div className="flex gap-4 items-center justify-center">
            <CustomButton_ onClick={handleReset}> Reset </CustomButton_>
