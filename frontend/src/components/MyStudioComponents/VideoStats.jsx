...
import { setShowEditVideo } from "@/features/ui.slice";
import { useDispatch } from "react-redux";
import { MdSearch } from "react-icons/md";

import { useDeleteVideo, useTogglePublish } from "@/hooks/video.hook";
import DeletePopup from "./DeletePopup";
import { setVideoForEdit } from "@/features/video.slice";
  ...
  return (
    <>
      <div className="relative ">
        <input
          className="w-full peer border-2 border-[#02647c] focus:border-[#14d0ff] bg-transparent py-2 pl-10 pr-4 rounded-md placeholder-cyan-400 outline-none transition-all duration-300 focus:shadow-lg"
          placeholder="Search videos"
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
        />
        <MdSearch
          className="absolute left-3 top-1/2 transform -translate-y-1/2 text-cyan-400 peer-focus:text-[#14d0ff]"
          size={20}
        />
      </div>
      <div className="overflow-x-auto rounded-lg md:block hidden">
        <table className="w-full min-w-[1200px] border-collapse border border-[#14d0ff] text-cyan-400">
          <thead>
            <tr>
              <th className="border-collapse border-b p-4 border-[#14d0ff]">
                Status
              </th>
              <th className="border-collapse border-b p-4 border-[#14d0ff]">
                Uploaded
              ...
              <th className="border-collapse border-b p-4 border-[#14d0ff]"></th>
            </tr>
          </thead>
          <tbody>
            {filteredVideos &&
              filteredVideos.map((video) => (
                <tr className="group border" key={video._id}>
                  <td className="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none whitespace-nowrap">
                    <div className="flex justify-center">
                      <label className="relative inline-block w-12 cursor-pointer ">
                        ...
                        />
                        <span className="inline-block h-6 w-full rounded-2xl bg-cyan-600 duration-200 after:absolute after:bottom-1 after:left-1 after:top-1 after:h-4 after:w-4 after:rounded-full after:bg-black after:duration-200 peer-checked:bg-[#14d0ff] peer-checked:after:left-7"></span>
                      </label>
                    </div>
                  </td>
                  <td className="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none whitespace-nowrap">
                  ...
                  <td className="border-collapse border-b border-cyan-600 px-4 py-3 group-last:border-none whitespace-nowrap">
                  ...
                  <td className="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none whitespace-nowrap">
                    <div className="flex gap-4">
                      <button
                        ...
                        className="h-5 w-5 hover:text-[#14d0ff]"
                      >
      ...
      <div className="md:hidden flex flex-wrap justify-between text-white">
        {filteredVideos &&
          filteredVideos.map((video) => (
            ...
            >
              <div className="flex flex-col border-[#14d0ff]  border-dashed rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <label className="relative inline-block w-12 cursor-pointer ">
                      <input
                        ...
                        onChange={() => togglePublishStatus(video._id)}
                      />
                      <span className="inline-block h-6 w-full rounded-2xl bg-gray-200 duration-200 after:absolute after:bottom-1 after:left-1 after:top-1 after:h-4 after:w-4 after:rounded-full after:bg-black after:duration-200 peer-checked:bg-[#14d0ff] peer-checked:after:left-7"></span>
                    </label>
                  </div>
