        ...
        >
          <div className="flex flex-wrap gap-y-4 p-4">
            ...
            <div className="w-full">
              ...
              <input
                type="password"
                className="w-full rounded-lg border border-[#20b2d6] placeholder:text-cyan-700 bg-transparent px-2 py-1.5"
                id="cnfrm-pwd"
          ...
          <div className="flex items-center justify-end gap-4 p-4">
            ...
            <button className="inline-block bg-[#023542] px-3 py-1.5 text-cyan-400 rounded-md">
              Update Password
            </button>
          </div>
        </form>
