  ...
  return (
    <div className="flex flex-wrap justify-center gap-y-4 py-4">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3">
        ...
        <p className="text-cyan-400">Update your photo and personal details.</p>
      </div>
        ...
        >
          <div className="flex flex-wrap gap-y-4 p-4">
            <div className="w-full lg:w-1/2 lg:pr-2">
              ...
              <input
                type="text"
                className="w-full rounded-lg border border-[#20b2d6] bg-transparent px-2 py-1.5"
                id="firstname"
            ...
            <div className="w-full">
              ...
              <div className="relative">
                <div className="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-cyan-300">
                  <svg
                ...
                <input
                  type="text"
                  className="w-full rounded-lg border border-[#20b2d6] bg-transparent py-1.5 pl-10 pr-2"
                  id="lastname"
          ...
          <div className="flex items-center justify-end gap-4 p-4">
            ...
            <button
              type="submit"
              className="inline-block bg-[#09353f] px-3 py-1.5 text-cyan-400 rounded-md"
            >
              Save changes
            </button>
          </div>
