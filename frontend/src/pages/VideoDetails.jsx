...
// import { setSidebarFullSize } from "../features/ui.slice.js";
import { setVideo } from "../features/video.slice.js";
          ...
          >
            <div className="flex flex-wrap gap-y-2">
              <div className="w-full md:w-1/2 lg:w-full xl:w-1/2">
                ...
                <p className="flex text-sm text-cyan-800">
            ...
            <hr className="my-4 border-[#20b2d6]" />
