...
import { Subscriber, SubscriberTweetSkeleton } from "../../components/index";
...
function ChannelSubscribers() {
  ...
  const { data: channelSubscribers, isLoading } = useChannelSubcribers(
    channelId,
    isGuest
  );
      ...
      <div className="flex justify-center p-4 mt-4">
        <div className="w-full max-w-sm text-center">
          <p className="mb-3 w-full">
            <span className="inline-flex rounded-full bg-[#0e536b] p-2 text-[#20b2d6]">
